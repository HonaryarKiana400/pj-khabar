    ...
    <div class="all">
        ...
        <nav class="navbar navbar-dark fixed-top" style="background-color: #f0f0f0; padding-top: 32px; padding-bottom: 18px;">
            <div class="container-fluid">
                ...
                <div class="search">
                    <form class="d-flex" role="search" action="category_news.php" method="GET">
                        <input class="form-control me-2" type="search" name="search" placeholder="جستجو بر اساس عنوان خبر" aria-label="Search">
